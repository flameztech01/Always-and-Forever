        ...
        <div className="max-w-6xl mx-auto space-y-8 md:space-y-12">
          {venues.map((venue) => (
            <div key={venue.id} className="relative group">
              ...
              <div className={`absolute inset-0 bg-gradient-to-r ${venue.color} opacity-20 rounded-3xl blur-2xl group-hover:blur-3xl transition-all duration-500`} />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex items-start gap-4">
                        <div className={`bg-gradient-to-br ${venue.color} p-4 rounded-2xl shadow-lg`}>
                          <div className="text-white">
                            {venue.icon}
                          </div>
                        </div>
                        <div>
                          <p className="text-sm text-amber-600 font-light tracking-wider mb-1">{venue.name}</p>
                      ...
                      <div className="relative rounded-2xl overflow-hidden shadow-xl border-4 border-white/50 group/map h-64">
                        <div className="w-full h-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center">
                          <div className="text-center">
                            ...
                            <p className="text-amber-800 font-medium">{venue.venueName}</p>
                            <p className="text-sm text-amber-600">{venue.address[0]}</p>
                          </div>
                        </div>
                      ...
                      <div className="bg-gradient-to-r from-amber-50 to-amber-100/50 rounded-2xl p-6 border border-amber-200">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-3">
                            ...
                            <p className="text-sm text-gray-600">{venue.transport.car}</p>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="bg-white p-2 rounded-full mt-1">
                              <FaBus className="text-amber-500 text-sm" />
                            </div>
                            <p className="text-sm text-gray-600">{venue.transport.bus}</p>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="bg-white p-2 rounded-full mt-1">
                              <MdLocalParking className="text-amber-500 text-sm" />
                            </div>
                            <p className="text-sm text-gray-600">{venue.transport.parking}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white p-4 rounded-xl border border-amber-200">
                          ...
                          <p className="font-medium text-gray-800 text-sm">
                            {venue.id === 1 ? 'Street parking' : 'On-site parking'}
                          </p>
                        </div>
                        <div className="bg-white p-4 rounded-xl border border-amber-200">
